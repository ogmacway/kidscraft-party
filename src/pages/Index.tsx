  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary py-12 px-4 sm:py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 leading-tight">SUPER KIT 300 PERSONAGENS
 para seu filho fazer e ficar longe das telas</h1>
